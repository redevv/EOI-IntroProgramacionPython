...
ListaPromedioAnual = sorted(DiccPromedioAnual,key=DiccPromedioAnual.get,reverse=True) # Sustituye a líneas 34 y 35. "sorted" sólo muestra la clave, para generar el valor debemos hacer un "for"
#print(f'La lista de las ciudades ordenadas es :\n{ListaPromedioAnual}')

for i in ListaPromedioAnual:
